...
import { APP_NAME, APP_VERSION, AUTH_TYPES, COLORS, FONT, SHADOWS, SIZES } from '../../../constants/theme'
...
import RegisterWithMobile from '../../../components/RegisterWithMobile'
      ...
      <SafeAreaView style={tw` bg-white h-full`}>
        ...
        {AUTH_TYPES.MOBILE && AUTH_TYPES.EMAIL &&
          <NavigationContainer independent={true}>
            ...
            >
              <tab.Screen name="Mobile" component={RegisterWithMobile} />
              <tab.Screen name="Email" component={RegisterWithEmail} />
            </tab.Navigator>
          </NavigationContainer>}
